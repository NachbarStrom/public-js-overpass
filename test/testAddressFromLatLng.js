...
const api = require("../src/getAddressFromLatLng");
const _ = require("lodash");

describe("The getAddressFromLatLng", async () => {
  it("returns the address and geoJson of the place", async () => {
    const resp = await api.getAddressFromLatLng(TEST_HOUSE.lat, TEST_HOUSE.lng);
